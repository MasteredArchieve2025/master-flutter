...
class _Course4ScreenState extends State<Course4Screen> {
  ...
  Future<void> _fetchAdvertisements() async {
    debugPrint('🔄 Loading advertisements for coursepage4...');
    try {
  ...
  void _nextVideo() {
    if (youtubeUrls.isEmpty) return;
    setState(() {
      _currentVideoIndex = (_currentVideoIndex + 1) % youtubeUrls.length;
    });
  }
  ...
  void _previousVideo() {
    ...
    setState(() {
      _currentVideoIndex =
          (_currentVideoIndex - 1 + youtubeUrls.length) % youtubeUrls.length;
    });
  }
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: ConstrainedBox(
                      constraints: BoxConstraints(
                        minHeight: MediaQuery.of(context).size.height - headerHeight - MediaQuery.of(context).padding.top - 56, // Account for footer
                      ),
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    ...
                                    if (adImages.isEmpty && !_isLoadingAds && _apiCallFailed)
                                      Container(
                                        color: Colors.white,
                                    ...
                                    if (youtubeUrls.isNotEmpty) ...[
                                            ...
                                            children: [
                                              ...
                                              Row(
                                                children: [
                                                  ...
                                                  Text(
                                                    '${_currentVideoIndex + 1}/${youtubeUrls.length}',
                                                    style: const TextStyle(
                                                      color: Color(0xFF0B5ED7),
                                                      fontWeight: FontWeight.w600,
                                                    ),
                                      ...
                                      Padding(
                                        ...
                                        child: CommonYoutubePlayer(
                                          youtubeUrl: youtubeUrls[_currentVideoIndex],
                                          height: isDesktop ? 360 : (isTablet ? 320 : 220),
                                          placeholderThumbnail: _getVideoThumbnail(
                                              youtubeUrls[_currentVideoIndex]),
                                          borderRadius: 0,
                                        ),
                                      ),
                                    ] else
